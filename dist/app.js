            ...
            var e = {
                ...
                renderMap: function() {
                    ...
                    if (this.ready) {
                        ...
                        L ? (z.addColorStop(0, "rgba(255, 255, 255, 0.95)"), z.addColorStop(1, "rgba(185, 217, 151, 0)")) : (z.addColorStop(0, "rgba(255, 255, 255, 0.85)"), z.addColorStop(1, "rgba(255, 255, 255, 0)")), this.ctx.fillStyle = z, this.ctx.fillRect(0, 0, this.sectionsBounds[0].right + 200, this.state.height), L && T(this.ctx)
                    }
                },
                render: function() {
                    this.renderMap()
